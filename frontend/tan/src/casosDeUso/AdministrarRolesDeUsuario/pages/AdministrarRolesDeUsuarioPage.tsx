...
import { Navbar } from "@/generalComponents";
...
const AdministrarRolesDeUsuarioPage: React.FC = () => {
  ...
  return (
    <>
      {/*  El contenido principal, sin margen superior para que la navbar quede arriba */}
      <div style={{width: '100%', minHeight: 'calc(100vh - 80px)', background: 'transparent', margin: 0, padding: '32px 0 0 0'}}>
        <h2 className="modal-roles__title" style={{marginLeft: 40}}>Administración de Roles de Usuarios</h2>
        <p className="modal-roles__desc" style={{marginLeft: 40}}>Gestiona los roles y permisos de los usuarios del sistema.</p>
        <div style={{display: 'flex', gap: 32, minHeight: 400, marginLeft: 40, marginRight: 40}}>
          <div className="roles-page__flex" style={{width: '100%'}}>
