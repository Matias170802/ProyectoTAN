      ...
      <div className="modal-roles__container">
        ...
        <div className="modal-roles__content">
          {loading ? (
            ...
            <div className="modal-roles__layout">

              {/* ===== COLUMNA IZQUIERDA ===== */}
              <div className="modal-roles__left">
                <div className="modal-roles__left-header">
              ...
              {/* ===== COLUMNA DERECHA ===== */}
              <div className="modal-roles__right">
                {selectedEmpleado ? (
                  <>
                  ...
                  <span className="modal-roles__empty">
                    Selecciona un empleado para editar sus roles.
                  </span>
                )}
              </div>
