...
public class DataInitialazer {
    ...
    public void initializeData() {
        ...
        if (reservaRepository.count() == 0) {
            ...
            Reserva r1 = new Reserva("RES001", LocalDateTime.now().plusDays(2), LocalDateTime.now().plusDays(7), LocalDateTime.now(), 5, 2, 25000.0, 10000.0, 10000.0, "Airbnb", in1, estSenada);
            Reserva r2 = new Reserva("RES002", LocalDateTime.now().plusDays(10), LocalDateTime.now().plusDays(15), LocalDateTime.now(), 5, 4, 35000.0, 15000.0, 15000.0, "Booking", in2, estSenada);
            Reserva r3 = new Reserva("RES003", LocalDateTime.now().plusDays(20), LocalDateTime.now().plusDays(25), LocalDateTime.now(), 5, 3, 30000.0, 12000.0, 12000.0, "Directo", in3, estPreparada);
            Reserva r4 = new Reserva("RES004", LocalDateTime.now().plusDays(30), LocalDateTime.now().plusDays(35), LocalDateTime.now(), 5, 2, 22000.0, 8000.0, 8000.0, "Airbnb", in4, estFinalizada);
            Reserva r5 = new Reserva("RES005", LocalDateTime.now().plusDays(40), LocalDateTime.now().plusDays(45), LocalDateTime.now(), 5, 2, 27000.0, 9000.0, 9000.0, "Booking", in1, estCancelada);
